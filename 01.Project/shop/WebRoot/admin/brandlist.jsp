...
<!-- 标题栏 --begin-->
	   			<div class="listbiaoti am-cf">
	      			<ul class="am-icon-flag on"> 品牌列表</ul>
	     				<dl class="am-icon-home" style="float: right;"> 当前位置： 首页 > <a href="goodslist.jsp">品牌列表</a></dl>
	      				<dl><a class="am-btn am-btn-danger am-round am-btn-xs am-icon-plus" href="brandadd.jsp"> 添加品牌</a></dl>
				</div>
<!-- 标题栏 --end-->
        ...
        <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped am-table-hover">
          <thead>
            <tr class="am-success">
              ...
              <th class="table-id">ID</th>
               ...
               <th class="table-type" width="140px">LOGO</th> 
          ...
          <c:forEach items="${list}" var="b">
            <tr style="text-align: center;">
              ...
              <td style="padding: 0px;line-height: 50px;" title="${b.brandID}">${b.brandID}</td>
             <td style="padding: 0px;line-height: 50px;" title="${b.brandName}">${b.brandName}</td>
             
            
              <td style="padding: 0px;line-height: 50px;" title="${b.brandLogo}"><img  width="40px;" height="40px;" src="../upload/${b.brandLogo}"></td>
             <td style="padding: 0px;line-height: 50px;" title="${b.url}">${b.url}</td>
                <td style="padding: 0px;line-height: 50px;" title="${b.isShow}">${b.isShow}</td>
