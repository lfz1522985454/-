...
<!-- 标题栏 --begin-->
	   			<div class="listbiaoti am-cf">
	      			<ul class="am-icon-flag on"> 商品分类</ul>
	     				<dl class="am-icon-home" style="float: right;"> 当前位置： 首页 > <a href="goodsstock.jsp">商品分类</a></dl>
	      				<dl><a class="am-btn am-btn-danger am-round am-btn-xs am-icon-plus" href="goodsstockadd.jsp"> 添加分类</a></dl>
				</div>
<!-- 标题栏 --end-->
        ...
        <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped am-table-hover">
          <thead>
            <tr class="am-success">
              ...
              <th class="table-id">ID</th>
               ...
               <th class="table-type" width="140px">关键字</th> 
              <th class="table-type">说明</th>
              <th class="table-type" width="140px">显示/不显示</th>
          ...
          <c:forEach items="${list}" var="x">
            <tr style="text-align: center">
              ...
              <td class="am-text-center">${x.catID}</td>
              <td class="am-hide-sm-only">${x.catName}</td>
              <td class="am-hide-sm-only">${x.keywords}</td>
              <td class="am-hide-sm-only">${x.description}</td>
    		  <td class="am-hide-sm-only"><c:if test="${x.isShow==1}"><img width="20px;" height="20px;" src="assets/img/gou.png"/></c:if><c:if test="${x.isShow==0}"><img width="20px;" height="20px;"src="assets/img/cha.png"/></c:if></td>
			          ...
			          <!-- 换页 --begin-->
				           ...
				           <ul class="am-pagination am-fr">
				            <li>总行数：${zhs}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
				                ...
				                <li><a href="../CategoryServlet?index=1" style="<c:if test="${page.pageIndex==1}">display: none;</c:if>">首页</a></li>
				                <li><a href="../CategoryServlet?index=${page.pageIndex-1}" style="<c:if test="${page.pageIndex==1}">display: none;</c:if>">上一页</a></li>
				                <li><a href="../CategoryServlet?index=${page.pageIndex+1}" style="<c:if test="${page.pageIndex==page.index}">display: none;</c:if>">下一页</a></li>
				                <li><a href="../CategoryServlet?index=${page.index}" style="<c:if test="${page.pageIndex==page.index}">display: none;</c:if>">尾页</a></li>
				           </ul>
			       	   <!-- 换页 --end-->
        <hr />
        <p>
