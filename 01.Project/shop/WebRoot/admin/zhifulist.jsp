...
<!-- 标题栏 --begin-->
	   			<div class="listbiaoti am-cf">
	      			<ul class="am-icon-flag on"> 支付方式</ul>
	     				<dl class="am-icon-home" style="float: right;"> 当前位置： 首页 > <a href="goodslist.jsp">支付方式</a></dl>
	      				<dl><a class="am-btn am-btn-danger am-round am-btn-xs am-icon-plus" href="zhifuadd.jsp"> 添加支付方式</a></dl>
				</div>
<!-- 标题栏 --end-->
        ...
        <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped am-table-hover">
          <thead>
            <tr class="am-success">
              ...
              <th  style="text-align: center;" class="table-id">ID</th>
               <th style="text-align: center;" class="table-type">图片</th>
          ...
          <c:forEach items="${list}" var="b">
            <tr style="text-align: center;">
              ...
              <td  style="padding: 0px;line-height: 50px;" title="${b.payId}">${b.payId}</td>
               <!-- <img  width="40px;" height="40px;" src="../upload/${x.thumbnail}"> -->
             <td style="padding: 0px;line-height: 50px;" title="${b.img}"><img  width="165px;" height="65px;" src="../upload/${b.img}"></td>
             <td style="padding: 0px;line-height: 50px;" title="${b.payName}">${b.payName}</td>
            
            <td style="padding: 0px;line-height: 50px;" title="${b.desctiption}">${b.desctiption}</td>
            <td style="padding: 0px;line-height: 50px;" ><c:if test="${b.enabled==1}"><img width="20px;" height="20px;" src="assets/img/gou.png"/></c:if><c:if test="${b.enabled==0}"><img width="20px;" height="20px;"src="assets/img/cha.png"/></c:if></td>
